...
public class JwtTokenUtil {
    ...
    public String generateToken(String Membername) {
        ...
        return createToken(claims, Membername);
    }

    // 토큰 유효성 검사
    public Boolean validateToken(String token, String Membername) {
        final String extractedMembername = extractMembername(token);
        return extractedMembername.equals(Membername) && !isTokenExpired(token);
    }
