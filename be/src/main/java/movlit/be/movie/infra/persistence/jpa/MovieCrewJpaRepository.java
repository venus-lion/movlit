...
public interface MovieCrewJpaRepository extends JpaRepository<MovieRCrewEntity, MovieRCrewIdForEntity> {
    ...
    @Query("SELECT NEW movlit.be.movie.presentation.dto.MovieDetailCrewResponse(mc.movieCrewEntity.profileImgUrl, mc.movieCrewEntity.name, mc.movieCrewEntity.charName, mc.movieCrewEntity.role) "
