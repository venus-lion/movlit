...
import movlit.be.common.exception.MemberAndMovieCommentNotMatchedException;
...
public class MovieDetailWriteService {
    ...
    public void deleteComment(MovieCommentDataForDelete data) {
        ...
        validateMemberAndMovieComment(currentMemberId, movieCommentEntity);

        movieCommentRepository.deleteComment(movieCommentId);
    }

    private void validateMemberAndMovieComment(MemberId currentMemberId, MovieCommentEntity movieCommentEntity) {
