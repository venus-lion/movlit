...
public class MovieConverter {
    ...
    public static Movie toDomain(MovieEntity movieEntity) {
        ...
        return Movie.builder()
                ...
                .movieTagList(movieEntity.getMovieTagEntityList().stream()
                        .map(MovieTagConverter::toDomain)
                        .collect(Collectors.toList()))
                .movieRCrewList(movieEntity.getMovieRCrewEntityList().stream()
                        .map(MovieCrewConverter::toRCrewDomain).toList()
                )
