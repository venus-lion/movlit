package movlit.be.ex.feed_collection_comment.domain.entity;
...
import movlit.be.ex.feed_collection_comment.domain.FeedCollectionCommentAddedEvent;
import movlit.be.ex.feed_collection_comment.domain.FeedCollectionReplyIds;

@NoArgsConstructor(access = AccessLevel.PROTECTED)
@Entity
public class FeedCollectionCommentEntity {
    ...
    public FeedCollectionCommentEntity(
