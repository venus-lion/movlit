...
import static movlit.be.acceptance.book.BookMainSteps.베스트셀러_도서_리스트를_조회한다;
import static movlit.be.acceptance.book.BookMainSteps.상태코드가_200_이고_응답데이터가_존재한다;
