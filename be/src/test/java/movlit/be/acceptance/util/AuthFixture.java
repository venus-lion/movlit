...
import static movlit.be.acceptance.util.MemberFixture.사용자_민지;
import static movlit.be.acceptance.util.MemberFixture.사용자_원준;
import static movlit.be.acceptance.util.MemberFixture.사용자_윤기;
import static movlit.be.acceptance.util.MemberFixture.사용자_지원;
